...

{
  ...
  boot.initrd.luks.devices."luks-96ff6cc8-4502-4fcf-8261-90f5a018a085".device = "/dev/disk/by-uuid/96ff6cc8-4502-4fcf-8261-90f5a018a085";
...
# ripgrep-all # better grep + find
    fd # better find
    bat # better cat
    du-dust # better du
   # eza # better ls exa no longer used
